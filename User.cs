...
namespace LibraryManagment
{
    internal class User
    {
        ...
        {
            FileStream fileStreamObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\inventoryDetails.txt", FileMode.Open, FileAccess.Read);
            FileStream fileStreamWObj = new FileStream(@"C:\Users\Boss\Desktop\console\ConsoleApp\LibraryManagment\LibraryManagment\inventoryDetails.txt", FileMode.Append, FileAccess.Write);
